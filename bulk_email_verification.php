...
$url = 'https://apps.emailvalidation.fr/api/verifApiFile?secret='.$key.'&filename=my_emails.txt';
$ch = curl_init($url);
...
<!-- download ready file -->
$key = "PUT YOUR API KEY HERE";
            $url = 'https://apps.emailvalidation.fr/api/getApiFileInfo?secret='.$key.'&id=10700';
